...
class DataNodeStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PurgeMainData = channel.unary_unary(
                '/datanode.DataNode/PurgeMainData',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                )
...
def add_DataNodeServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'PurgeMainData': grpc.unary_unary_rpc_method_handler(
                    servicer.PurgeMainData,
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
...
class DataNode(object):
    ...
    def PurgeMainData(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/datanode.DataNode/PurgeMainData',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
